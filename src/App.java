public class App {
    public static void main(String[] args) throws Exception {
        ...
        String data6 = "trangThaiAnChi^{\"serial\": \"CKBL001009\"},{\"serial\": \"CKBL001010\"}";
        String data7 = "getCustomerInfoById^10230001";
        ...
        String res = CallAPIController.CallESBRestAPI(data6);
